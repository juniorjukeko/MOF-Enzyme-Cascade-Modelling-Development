...
def load_parameters(model):
    ...
    model.EA = pyo.Param(mutable=True, initialize=config.MAX_ENZYME_SURFACE_DENSITY['Enzyme_A'])  # (μmol/dm²)
    model.EB = pyo.Param(mutable=True, initialize=config.MAX_ENZYME_SURFACE_DENSITY['Enzyme_B'])  # (μmol/dm²)
